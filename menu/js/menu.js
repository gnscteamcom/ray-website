var Menu = (function() {
	...
	var $container = $( '#rm-container' ),						
		...
		viewDetails = function( recipe ) {
			...
			var $modal = $( '<div class="rm-modal"><div class="rm-thumb" style="background-image: url(' + img + ')"></div><h5>' + title + '</h5><p>' + description + '</p><a href="' + url + '">See more</a><span class="rm-close-modal">x</span></div>' );
